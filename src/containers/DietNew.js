        ...
        return (
            <div class="wrapper">
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="input-field">
                        <input type="text" name="gender" id="gender" value={this.state.gender} onChange={this.handleChange} />
                    ...
                    <div className="input-field">
                        <input type="text" name="diet_type" id="diet_type" value={this.state.diet_type} onChange={this.handleChange} />
                        <label htmlFor="diet_type">Diet Type</label>
                    </div>
                    <div className="input-field">
                        <input type="text" name="start_weight" id="start_weight" value={this.state.start_weight} onChange={this.handleChange} />
                        <label htmlFor="start_weight">Start Weight</label>
                    </div>
                    <div className="input-field">
                        <input type="text" name="lost_weight" id="lost_weight" value={this.state.lost_weight} onChange={this.handleChange} />
